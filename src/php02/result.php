        ...
        <div class="result-content">
            <div class="result-cards">
                <div class="result-card">
                    ...
                    <div class="result-card__body">
                        <p class="result-card__body-city"><?php echo $tokyo['name']?></p>
                        <p class="result-card__body-time"><?php echo $tokyo['time']?></p>
                    </div>
                </div>
                <div class="result-card">
                    <div class="result-card__img-wrapper">
                    ...
                    <div class="result-card__body">
                        <p class="result-card__body-city"><?php echo $comparison['name']?></p>
                        <p class="result-card__body-time"><?php echo $comparison['time']?></p>
                    </div>
                </div>
            </div>
        </div>
